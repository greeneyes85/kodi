...
from .apiumando import movies as api_movies
from .apiumando import tvShows as api_tvShows
from .apiumando import anime as api_anime
...
def _getDomains():
    domains = [
        # Custom domain for Kodi Popcorntime
        "https://api.apiumando.info"
    ]
